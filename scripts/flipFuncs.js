...
function validateMyForm(counter, flag){
	...
	if( titles.length != 0 ){
		if(flag){
		    ...
		    $.ajax({
			url: 'flashcardselect.php?Result=' + processString(titles.toString())+'&c='+document.getElementById('f').title, 
			dataType: 'html', 
			success: 
				function(object) {
			...
			$.ajax({url: 'flashcardselect.php?Change=' + processString(titles.toString())+'&c='+document.getElementById('f').title, dataType: 'html', 
...
function reSubmitCards(counter){
	...
	$.ajax({url: 'flashcardselect.php?edit=' + processString(results)+'&c='+document.getElementById('f').title, dataType: 'html', success: function(object) {
		$('#f').html(object);
		}, asyc: true
	 });
}
...
function addCards(counter){
	...
	$.ajax({url: 'flashcardselect.php?add='+processString(t.toString())+'&c='+document.getElementById('f').title, dataType: 'html', 
		success: function(object) {
				$('#f').html(object);}, 
...
function sumitNewCards(){
	makeNewCardsArray();
	$.ajax({url: 'flashcardselect.php?inst='+processString(cards)+'&c='+document.getElementById('f').title, dataType: 'html', success: function(object) {
